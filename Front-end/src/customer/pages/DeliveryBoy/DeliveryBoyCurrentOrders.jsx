...
const DeliveryBoyCurrentOrders = () => {
    ...
    useEffect(() => {
        const fetchAllCurrentOrder = async () => {
            ...
            try {
                const response = await axios.get(`http://localhost:8080/food-orders/getAllAcceptOntheWayOrders/` + parsedData.id, {
                    headers: {
    ...
    const handleDeliverOrder = async (event) => {
        ...
        try {
            const response = await axios.get(`http://localhost:8080/food-orders/deliver-order/` + event, {
                headers: {
                    "Content-Type": "application/json"
                }
            });
    ...
    return (
        <div>
            ...
            <h1 className='text-center font-semibold text-2xl py-10'>Your Current Orders</h1>
                        ...
                        <div className='space-y-3 text-gray-500'>
                            ...
                            <div className='p-5'>
                                ...
                                <div className='mt-5'>
                                    ...
                                    <Button variant='contained' onClick={() => handleDeliverOrder(item.ordId)}>
...
export default DeliveryBoyCurrentOrders
