...
const RestaurantOrders = () => {
    ...
    const [restaurantOrderList, setRestaurantOrderList] = useState([]);
    ...
    useEffect(() => {
        const fetchAllCurrentOrder = async () => {
            ...
            try {
                const response = await axios.get(`http://localhost:8080/food-orders/getAllAcceptOrderForRestaurant/` + parsedData.resId, {
                    headers: {
                        "Content-Type": "application/json"
                    }
                });

                setRestaurantOrderList(response.data);
    ...
    return (
        <div>
            ...
            <div className='flex flex-wrap justify-between'>
                ...
                {restaurantOrderList.map((item, index) => (
